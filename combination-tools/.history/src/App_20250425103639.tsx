  ...
  return (
    ...
    >
      ...
      <Drawer title="试运行" onClose={onClose} open={open}>
        ...
        <h4 style={{margin:'0',padding:'0'}}>试运行输入</h4>
        {getNodes().map((data) => {
          if (data.id == 'a') {
         ...
         <h4 style={{margin:'10 0 0 0',padding:'0'}}>输出结果</h4>
        ...
        <Button style={{ position: 'absolute', bottom: '80px', right: '80px' }} type="primary" onClick={onExecute}>执行</Button>
