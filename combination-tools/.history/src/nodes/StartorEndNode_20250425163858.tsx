            ...
            >
                ...
                {data.outputs?.map((item) => {
                    return <Flex style={{ backgroundColor: '#f5f5f5', padding: '4px', borderRadius: '4px' }} wrap key={item.key} gap="small" className='margin-top' align='center'>
                        ...
                        {
                            item.isFold ? 
                            <Avatar style={{ position: 'relative', left: '10px' }} onClick={() => handleDelete(item.key)} className='avatar' src={deleteInput}></Avatar> : <Avatar style={{ position: 'relative', left: '10px' }} onClick={() => handleDelete(item.key)} className='avatar' src={deleteInput}></Avatar>
                        }
